//#include <Servo.h>
//
//Servo FRLservo; //front right lift servo
//Servo FLLservo; //front left lift servo
//Servo BRLservo; //back right lift servo
//Servo BLLservo; //back left lift servo
//
//Servo FRTservo; //front right turn servo
//Servo FLTservo; //front left turn servo
//Servo BRTservo; //back right turn servo
//Servo BLTservo; //back left turn servo
//
//void setup() {
//  // put your setup code here, to run once:
//FRLservo.attach(6); //lift servos
//FLLservo.attach(4);
//BRLservo.attach(8);
//BLLservo.attach(2);
//
//FRTservo.attach(7); //turn servos
//FLTservo.attach(5);
//BRTservo.attach(9);
//BLTservo.attach(3);
//
//FRLservo.write(30); //center
//FLLservo.write(30);
//BRLservo.write(30);
//BLLservo.write(30);
//
//FRTservo.write(70); //center
//FLTservo.write(70);
//BRTservo.write(70);
//BLTservo.write(70);
//
